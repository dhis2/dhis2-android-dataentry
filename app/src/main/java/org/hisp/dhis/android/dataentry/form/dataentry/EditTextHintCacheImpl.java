...
// ToDo: refactor edit-text hint cache
public class EditTextHintCacheImpl implements EditTextHintCache {
    ...
    public EditTextHintCacheImpl(Context context) {
        ...
        hintCache.append(R.string.enter_text,
                context.getString(R.string.enter_text));
        hintCache.append(R.string.enter_long_text,
                context.getString(R.string.enter_long_text));
        hintCache.append(R.string.enter_number,
                context.getString(R.string.enter_number));
        hintCache.append(R.string.enter_integer,
                context.getString(R.string.enter_integer));
        hintCache.append(R.string.enter_negative_integer,
        ...
        hintCache.append(R.string.enter_positive_integer,
                context.getString(R.string.enter_positive_integer));
        hintCache.append(R.string.enter_coordinates,
                context.getString(R.string.enter_coordinates));
        hintCache.append(R.string.enter_date,
                context.getString(R.string.enter_date));
        hintCache.append(R.string.enter_option_set,
                context.getString(R.string.enter_option_set));
    }
